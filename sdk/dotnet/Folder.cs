...
namespace Jschady.Filescom
{
    ...
    /// ```
    /// </summary>
    [FilescomResourceType("filescom:index/folder:Folder")]
    public partial class Folder : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("mkdirParents")]
        public Output<bool?> MkdirParents { get; private set; } = null!;
        ...
        public Folder(string name, FolderArgs args, CustomResourceOptions? options = null)
            : base("filescom:index/folder:Folder", name, args ?? new FolderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Folder(string name, Input<string> id, FolderState? state = null, CustomResourceOptions? options = null)
            : base("filescom:index/folder:Folder", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FolderArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("mkdirParents")]
        private Input<bool>? _mkdirParents;

        /// <summary>
        /// **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
        /// Create parent directories if they do not exist?
        /// </summary>
        public Input<bool>? MkdirParents
        {
            get => _mkdirParents;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _mkdirParents = Output.Tuple<Input<bool>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
