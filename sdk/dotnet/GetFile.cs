...
namespace Jschady.Filescom
{
    public static class GetFile
    {
        ...
        public static Task<GetFileResult> InvokeAsync(GetFileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileResult>("filescom:index/getFile:getFile", args ?? new GetFileArgs(), options.WithDefaults());
        ...
        public static Output<GetFileResult> Invoke(GetFileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFileResult>("filescom:index/getFile:getFile", args ?? new GetFileInvokeArgs(), options.WithDefaults());
