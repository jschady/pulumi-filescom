...
namespace Jschady.Filescom
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/jschady/pulumi-filescom";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Jschady.Filescom.version.txt");
    ...
    internal sealed class FilescomResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FilescomResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
