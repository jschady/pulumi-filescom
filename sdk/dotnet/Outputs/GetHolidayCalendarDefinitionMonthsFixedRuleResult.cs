...
namespace Jschady.Filescom.Outputs
{
    ...
    [OutputType]
    public sealed class GetHolidayCalendarDefinitionMonthsFixedRuleResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetHolidayCalendarDefinitionMonthsFixedRuleYearRangesResult YearRanges;

        [OutputConstructor]
        private GetHolidayCalendarDefinitionMonthsFixedRuleResult(
            string endTime,
            ...
            Outputs.GetHolidayCalendarDefinitionMonthsFixedRuleYearRangesResult yearRanges)
        {
            EndTime = endTime;
            Mday = mday;
            Name = name;
