...
namespace Jschady.Filescom.Outputs
{
    ...
    [OutputType]
    public sealed class HolidayCalendarDefinitionMonthsCalculatedRule
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.HolidayCalendarDefinitionMonthsCalculatedRuleYearRanges? YearRanges;

        [OutputConstructor]
        private HolidayCalendarDefinitionMonthsCalculatedRule(
            string? endTime,
            ...
            Outputs.HolidayCalendarDefinitionMonthsCalculatedRuleYearRanges? yearRanges)
        {
            EndTime = endTime;
            Function = function;
