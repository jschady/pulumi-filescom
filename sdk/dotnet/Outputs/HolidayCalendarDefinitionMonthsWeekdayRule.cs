...
namespace Jschady.Filescom.Outputs
{
    ...
    [OutputType]
    public sealed class HolidayCalendarDefinitionMonthsWeekdayRule
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.HolidayCalendarDefinitionMonthsWeekdayRuleYearRanges? YearRanges;

        [OutputConstructor]
        private HolidayCalendarDefinitionMonthsWeekdayRule(
            string? endTime,
            ...
            Outputs.HolidayCalendarDefinitionMonthsWeekdayRuleYearRanges? yearRanges)
        {
            EndTime = endTime;
            Name = name;
            Observed = observed;
