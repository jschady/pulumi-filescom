...
namespace Jschady.Filescom.Inputs
{
    ...
    public sealed class AutomationDefinitionNodeSendEmailConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("attachments")]
        ...
        [Input("onErrors")]
        private InputList<Inputs.AutomationDefinitionNodeSendEmailConfigOnErrorGetArgs>? _onErrors;

        /// <summary>
        /// Error handlers. Each item selects an error pattern and whether to continue or propagate it.
        /// </summary>
        public InputList<Inputs.AutomationDefinitionNodeSendEmailConfigOnErrorGetArgs> OnErrors
        {
            get => _onErrors ?? (_onErrors = new InputList<Inputs.AutomationDefinitionNodeSendEmailConfigOnErrorGetArgs>());
            set => _onErrors = value;
        }
        ...
        public AutomationDefinitionNodeSendEmailConfigGetArgs()
        {
        }
        public static new AutomationDefinitionNodeSendEmailConfigGetArgs Empty => new AutomationDefinitionNodeSendEmailConfigGetArgs();
    }
}
