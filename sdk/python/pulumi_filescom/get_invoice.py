...
def get_invoice(id: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('filescom:index/getInvoice:getInvoice', __args__, opts=opts, typ=GetInvoiceResult).value
...
def get_invoice_output(id: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('filescom:index/getInvoice:getInvoice', __args__, opts=opts, typ=GetInvoiceResult)
