...
export function getAutomationRun(args: GetAutomationRunArgs, opts?: pulumi.InvokeOptions): Promise<GetAutomationRunResult> {
    ...
    return pulumi.runtime.invoke("filescom:index/getAutomationRun:getAutomationRun", {
        "id": args.id,
    }, opts);
}
...
export interface GetAutomationRunResult {
     ...
     */
    readonly automationVersionId: number;
    /**
     ...
     */
    readonly retriedInRunId: number;
    /**
 ...
 * <!--End PulumiCodeChooser -->
 */
export function getAutomationRunOutput(args: GetAutomationRunOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutomationRunResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("filescom:index/getAutomationRun:getAutomationRun", {
        "id": args.id,
    }, opts);
}
