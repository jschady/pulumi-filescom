...
export function getAutomation(args: GetAutomationArgs, opts?: pulumi.InvokeOptions): Promise<GetAutomationResult> {
    ...
    return pulumi.runtime.invoke("filescom:index/getAutomation:getAutomation", {
        "id": args.id,
    }, opts);
}
...
export interface GetAutomationResult {
     ...
     */
    readonly alwaysSerializeJobs: boolean;
    /**
     * Automation type
     */
     ...
     */
    readonly definition: outputs.GetAutomationDefinition;
    /**
     ...
     */
    readonly inboundEmailAddress: string;
    /**
...
export function getAutomationOutput(args: GetAutomationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutomationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("filescom:index/getAutomation:getAutomation", {
        "id": args.id,
    }, opts);
}
