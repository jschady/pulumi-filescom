module github.com/jschady/pulumi-filescom/examples/basic-go

go 1.26.0

replace github.com/jschady/pulumi-filescom/sdk/go/filescom => ../../sdk/go/filescom

require (
	github.com/jschady/pulumi-filescom/sdk/go/filescom v0.0.0
