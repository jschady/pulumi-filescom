module github.com/jschady/pulumi-filescom/provider
...
replace github.com/Files-com/terraform-provider-files/shim => ./shim

require (
	github.com/Files-com/terraform-provider-files/shim v0.0.0
